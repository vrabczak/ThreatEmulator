...
- Re-evaluates an active emulator immediately after a threat is added, edited, deleted, or replaced by CSV; stale LOS work is canceled without interrupting aircraft AGL sampling.
