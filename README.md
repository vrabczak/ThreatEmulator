...
- Re-evaluates an active emulator after a threat is added, edited, deleted, or replaced by CSV; stale LOS terrain sampling is interrupted and discarded before the latest list is evaluated, without interrupting aircraft AGL sampling.
